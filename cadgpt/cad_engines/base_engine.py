...
class BaseCADEngine(ABC):
    ...
    def _parse_natural_language(self, text: str) -> tuple:
        """
        Parse natural language text to extract shape and parameters.
        
        Incluye instrucciones de formato para la IA:
        "Instrucciones de formato: solo entrega el código fuente, sin explicaciones, 
        sin razonamiento paso a paso, sin introducciones ni conclusiones. 
